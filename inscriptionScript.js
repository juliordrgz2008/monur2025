...
const AGNURButton = document.getElementById("AGNURDropdownButton");
const AGNURGroup = document.getElementById("AGNURGroup");
const AGNURNumber = document.getElementById("AGNURNumber");
const AGNURNames = document.getElementById("delegatesForAGNUR");
var AGNURNamesRowMax = 1;
...
allMiniForm(AGNURButton, AGNURGroup, AGNURNumber, AGNURNamesRowMax, AGNURNames);
